---
title: Dialogue systems with Scriptable Objects
...
It uses an IActor and IPanel interface to allow for dependency injection, letting you define any monobehaviour as an Actor that can be interacted with. It also includes basic interaction logic for a first person controller.
...
![Dialogue system example 1](/dialogue2.gif)
...
![Dialogue system example 2](/dialogue_data.png)
...
https://github.com/GarcGustavo/DungeonAutomata/tree/main/_Project/Scripts/DialogueSystem
