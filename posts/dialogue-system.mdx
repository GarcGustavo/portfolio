...
This is a dialogue system that uses scriptable objects to manage dialogue sequences as data. I developed it because I needed a simple tool for quickly adding dialogue or interactions to different types of games. 
